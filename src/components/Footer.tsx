...
const Footer = () => {
  return (
    <footer className="w-full bg-brand-primary text-brand-light font-brand">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <a
              ...
              className="block text-sm hover:text-brand-accent"
            >
            ...
            <div className="flex gap-4 mt-4">
              {socials.map((social, index) => (
                <Link key={index} href={social.link}>
                  <div className="text-xl hover:text-brand-accent transition-transform duration-300 ease-in-out hover:scale-110">
                    {social.icon}
                  </div>
                </Link>
              ))}
          ...
          {/* Contact Info */}
          <div>
            <h2 className="text-lg font-semibold mb-4 text-brand-accent">
              Contact Us
            </h2>
      ...
      {/* Divider & Copyright */}
      <div className="border-t border-brand-light/30 py-4 text-center text-xs opacity-80">
